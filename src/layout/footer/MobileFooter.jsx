        ...
        >
          {isLoggedIn ? (
            userInfo?.image ? (
              ...
              >
                <div className="leading-none font-bold h-6 w-6 rounded-full bg-white text-primary-600 flex items-center justify-center shadow-md text-xs border-2 border-white">
